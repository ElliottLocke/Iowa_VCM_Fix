...
def main():
    ...
    for row in textCSV:
        ...
        newtextcsvfile.write(", " + row[4]) #Construction  (Not in Data Dictionary)
        newtextcsvfile.write(", " + row[5]) #Mid_Lane_Obstruction    (Not in Data Dictionary)
